...
```{r}
dir.create(here("10_DataScienceCapstone/data/ngrams"))

save(unigram_tb, file = here("10_DataScienceCapstone/data/ngrams/unigrams.rda"))
save(bigram_tb, file = here("10_DataScienceCapstone/data/ngrams/bigrams.rda"))
save(trigram_tb, file = here("10_DataScienceCapstone/data/ngrams/trigrams.rda"))
```
...
download_data  <- function(locale, outdir) {
    here::i_am("10_DataScienceCapstone/report/milestone-report.Rmd")
